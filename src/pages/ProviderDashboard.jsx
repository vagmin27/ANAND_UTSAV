...
export default function ProviderDashboard() {
  ...
  const [loading, setLoading] = useState(false); // Restored loading state for logout
      ...
      <div className="dashboard-layout">
        <aside className="dashboard-sidebar">
          ...
          <nav className="sidebar-nav">
            <ul>
              <li className="nav-item"><Link to="#" className="active"><LayoutDashboard size={20} /> Dashboard</Link></li>
              <li className="nav-item"><a href="#" onClick={handleDummyLink}><Calendar size={20} /> Bookings</a></li>
              <li className="nav-item"><a href="#" onClick={handleDummyLink}><MessageSquare size={20} /> Messages</a></li>
